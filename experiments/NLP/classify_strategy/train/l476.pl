% L476: Machines A and B turn out respectively 10 percent and 90 percent of the total production of a certain type of article.  The probability that machine A turns out a defective item is 0.01 and the probability that machine B turns out a defective item is 0.05.  What is the probability that an article taken at random from the production line is defective? ## Solution= 0.046
