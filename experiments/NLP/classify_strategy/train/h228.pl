% H228: Three couples that were invited to dinner will independently show up with probabilities 0.9, 0.8, and 0.75.  Calculate the probability that 2 couples show up. ## Solution= .375
...
probability(exactly(2, 2-6, show)).
