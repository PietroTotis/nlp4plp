...
take(5-1, 6-3, 1).
observe(all(6-3, accuracy)).

probability(all(6-3, chlorinate)).

property(property, [accuracy]).
property(pollutant, [chlorinate, volatile, organic]).
