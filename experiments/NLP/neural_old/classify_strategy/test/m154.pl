% M154: 180 students in a tenth grade high school class take a survey about which video game consoles they own.  80 students answer that one of their consoles is a Playstation, 90 answer that one of their consoles is an Xbox.  Out of these, there are 30 who have both systems.  What is the probability that a randomly selected student has an Xbox? ## Solution= 1/2
