% M229: A ball is drawn at random from a box containing 10 red, 30 white, 20 blue and 15 orange balls.  What is the probability that it is white? ## Solution= 2/5
