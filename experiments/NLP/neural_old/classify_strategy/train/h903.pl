% H903: A satellite can fail for many possible reasons, two of which are computer failure and engine failure.  For a given mission, it is known that: The probability of engine failure is 0.008.  The probability of computer failure is 0.001.  Given engine failure, the probability of satellite failure is 0.98.  Given computer failure, the probability of satellite failure is 0.45.  Given any other component failure, the probability of satellite failure is zero.  Determine the probability that the satelite fails. ## Solution= .00829
