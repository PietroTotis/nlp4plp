% M153: 180 students in a tenth grade high school class take a survey about which video game consoles they own.  80 students answer that one of their consoles is a Playstation, 90 answer that one of their consoles is an Xbox.  Out of these, there are 30 who have both systems.  What is the probability that a randomly selected student has a Playstation? ## Solution= 4/9
...
probability(all(4-9, playstation)).
