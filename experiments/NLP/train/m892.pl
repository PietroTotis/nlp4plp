% M892: A box contains 7 balls numbered from 1 to 7.  If a ball is taken at random from the box, find the probability that it is not ball number 3. ## Solution= 6/7
