% L478: A ball is drawn at random from a box containing 10 red, 30 white, 20 blue and 15 orange balls.  Determine the probability that it is orange or red. ## Solution= 1/3
